...
public class Principal{
	...
	public static void main(String[] args) {
		...
		Usuario usuario = new Usuario("Eduardo", "111111", 201901, "eduardo.rocha", 1234);
		Admin admin = new Admin("Richard", "222222", 1871236, "richard.bruno", 4321);
		
		// Inicialização de Dados da lista - TEMA ESCOLHIDO: LIVROS
